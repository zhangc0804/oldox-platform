...
public class MyShiroWithRealm {
	
	private static final Logger logger = LoggerFactory.getLogger(MyShiroWithRealm.class);
	...
	public static void main(String[] args) {
		...
		if(!subject.isAuthenticated()){
			UsernamePasswordToken token = new UsernamePasswordToken("admin1", "7b916177edf7f7b0e9d447c0bbdaaafea54c7ab64cd361ed5a0ac684");
			try {
				subject.login(token);
